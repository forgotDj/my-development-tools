...
- [DeskFrame](https://github.com/PinchToDebug/DeskFrame): 桌面图标整理

## 监控

- [Portmaster](https://safing.io/): 类似 MacOS 的 Little Snitch 应用。它监控并管理所有进程的网络链接。可视化管理。
- [TrafficMonitor](https://github.com/zhongyang219/TrafficMonitor): 监控桌面悬浮窗。显示当前网速、CPU、内存等信息
  - [LiteMonitor](https://github.com/Diorser/LiteMonitor): 备选方案
